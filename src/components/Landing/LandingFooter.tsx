  ...
  return (
    <footer className="landing-footer">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="flex flex-col items-start justify-between gap-8 rounded-2xl border border-[#52ADFF]/25 bg-[linear-gradient(135deg,rgba(82,173,255,0.14),rgba(32,255,163,0.1))] px-6 py-8 sm:flex-row sm:items-center sm:px-10">
          <div>
            <p className="font-heading text-2xl font-bold tracking-tight text-[#1A1A1A] sm:text-3xl">
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-[#52ADFF]/15 pt-6 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-xs text-slate-500">
            © {new Date().getFullYear()} {BRAND_NAME}. All rights reserved.
          </p>
          <p className="font-mono text-[11px] tracking-[0.16em] text-slate-400 uppercase">
